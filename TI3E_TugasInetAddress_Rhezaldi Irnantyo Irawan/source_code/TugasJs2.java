 ...
 * @author User
 */
public class TugasJs2 extends javax.swing.JFrame {

    /**
     * Creates new form TugasJs2
     */
    public TugasJs2() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Hasil IP");

        jLabel3.setText("TUGAS JOBSHEET 2");

        jPanel1.setBackground(new java.awt.Color(102, 255, 255));

        jLabel4.setText("Masukkan Host");

        jLabel5.setText("Hasil IP");
...
jTextField4.setText(hostAddress );
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TugasJs2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
